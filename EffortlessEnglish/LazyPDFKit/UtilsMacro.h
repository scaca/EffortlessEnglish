...
#define ORA_NOTIFICATION_FOR_THEME_CHANGED @"ORA_NOTIFICATION_FOR_THEME_CHANGED"

/**
 *  默认导航栏和控制器背景色
 *
 */
#define kDefaultBackgroundColor  kColor(@"background_color")
/**
 *  默认cell的背景色
 *
 */
#define kDefaultCellBackgroundColor  kColor(@"list_color")
/**
 *  cell高亮状态和左右滑动后漏出的底色
 *
 */
#define kCellSelectedBackgroundColor  kColor(@"current_date_color")
...
#define kBlodFont16 [UIFont boldSystemFontOfSize:16]
#define kBlodFont17 [UIFont boldSystemFontOfSize:17]
#define kBlodFont18 [UIFont boldSystemFontOfSize:18]
...
#define kStrong(weakVar, _var)            \
    kStrong_DoNotCheckNil(weakVar, _var); \
    if (!_var) return;
